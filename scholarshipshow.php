...
<body>
  ...
  <div class="testbox">
    <form action="/">
      ...
      if (isset($_GET['t_id'])) {
        $user_id = $_GET['t_id'];
        $query = "SELECT * FROM scholarship WHERE id='$user_id'";
      ...
      ?>
            ...
            <div class="colums">
              ...
              <div class="item">
                <label for="sclname">School Name<span>*</span></label>
                <input id="sclname" type="text" value="<?php echo $row['sname'] ?>" name="sclname" required />
              </div>
              <div class="item">
                <label for="class">Class<span>*</span></label>
                <input id="class" type="text" name="class" value="<?php echo $row['class'] ?>" required />
              </div>
              <div class="item">
              ...
              <div class="item">
                ...
                <input id="zip" type="text" value="<?php echo $row['pcode'] ?>" name="zip" required />
              </div>
              <div class="item">
                <label for="city">Caste<span>*</span></label>
                <input id="city" type="text" value="<?php echo $row['caste'] ?>" name="city" required />
              </div>
              <div class="item">
                <label for="eaddress">Gender<span>*</span></label>
                <input id="eaddress" type="text" value="<?php echo $row['gender'] ?>" name="eaddress" required />
              </div>
              <div class="item">
                <label for="phone">Phone<span>*</span></label>
                <input id="phone" type="tel" value="<?php echo $row['pno'] ?>" name="phone" required />
              </div>
              <div class="item">
                <label for="phone">Email<span>*</span></label>
                <input id="phone" type="tel" value="<?php echo $row['email'] ?>" name="phone" required />
              </div>
              <div class="item">
                <label for="phone">Address<span>*</span></label>
                <input id="phone" type="tel" value="<?php echo $row['address'] ?>" name="phone" required />
              </div>
              <div class="item">
              ...
              <div class="item">
                <label for="phone">Account No<span>*</span></label>
                <input id="phone" type="tel" value="<?php echo $row['ano'] ?>" name="phone" required />
              </div>

              <div class="item">
                <label for="phone">city<span>*</span></label>
                <input id="phone" type="tel" value="<?php echo $row['city'] ?>" name="phone" required />
              </div>
            </div>
            <div class="item">
