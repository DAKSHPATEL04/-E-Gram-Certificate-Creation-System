...
<?php
    ...
    <?php
        $query2 = "select * from caste order by id desc limit 1";
        ...
        else
        {
            ...
            $customer_ID = "CCNO" . ($customer_ID +1);
        }
    ?>
...
<body>
    <div class="registration-form">
        <form action="castecode.php" method="post">
            <div class="form-group">
                <label class="create-account">CASTE CERTIFICATE</label>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <input name="caste" type="text" class="form-control item" id="Caste" placeholder="Caste">
            </div>
        ...
        <div class="form-group">
           <div class="form-group">
                <button name="caste_btn" type="submit"  value="ADD" class="btn btn-block create-account">Submit</button>
