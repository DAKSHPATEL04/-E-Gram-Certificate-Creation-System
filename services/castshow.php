...
<div id="container">
  ...
  <h1>&bull; CASTE CERTIFICATE &bull;</h1>
  <div class="underline">
  </div>
  ...
  <?php
                                       ...
                                       {
                                       $user_id = $_GET['t_id'];
                                       $query= "SELECT * FROM caste WHERE id='$user_id'";
    ...
    <div class="form-group">
      ...
      <input type="text" placeholder="caste" name="caste" id="caste_input" value="<?php echo  $row['caste']  ?>"required>
    </div>
    <div class="form-group">
