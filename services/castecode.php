...
if(isset($_POST['caste_btn']))
    {
     ...
     $Status=$_POST['Status'];
                ...
                $user_query = "INSERT into caste(id,uid,name,fname,mname,date,place,caste,gender,Remark,Status) values('$id','$uid','$name','$fname','$mname','$date','$place','$caste','$gender','$Remark','$Status')";
