...
<body>
  ...
  <div class="testbox">
    <form action="/">
      ...
      if (isset($_GET['t_id'])) {
        $user_id = $_GET['t_id'];
        $query = "SELECT * FROM jeevanbima WHERE id='$user_id'";
        $query_run = mysqli_query($con, $query);
        if (mysqli_num_rows($query_run) > 0) {
          foreach ($query_run as $row) {
      ?>
            <div class="banner">
              <h1><b>Jeevanbima</b></h1>
            </div>
            <div class="colums">
              <div class="item">
                <label for="ano"> Application No<span>*</span></label>
                <input id="ano" type="text" name="id" value=" <?php echo $row['id'] ?>" required />
              </div>
              <div class="item">
                <label for="name">Name of Nomiees<span>*</span></label>
                <input id="name" type="text" name="name" value=" <?php echo $row['name'] ?>" required />
              </div>
              <div class="item">
                <label for="oop">office of Posting<span>*</span></label>
                <input id="oop" type="text" name="oop" value=" <?php echo $row['oop'] ?>" required />
              </div>
              <div class="item">
              ...
              <div class="item">
                ...
                <input id="bdate" type="text" name="bdate" value=" <?php echo $row['bdate'] ?>" required />
              </div>
              <div class="item">
              ...
              <div class="item">
                <label for="pcode">Pin Code<span>*</span></label>
                <input id="pcode" type="text" name="pcode" value=" <?php echo $row['pcode'] ?>" required />
              </div>
              <div class="item">
                <label for="caste">Caste<span>*</span></label>
                <input id="caste" type="text" name="caste" value=" <?php echo $row['caste'] ?>" required />
              </div>
              <div class="item">
                <label for="gender">Gender<span>*</span></label>
                <input id="gender" type="text" name="gender" value="<?php echo $row['gender'] ?>" required />
              </div>
              <div class="item">
                <label for="pno">Phone No<span>*</span></label>
                <input id="pno" type="text" name="pno" value=" <?php echo $row['pno'] ?>" required />
              </div>
              <div class="item">
                <label for="adno">Adharcard Number<span>*</span></label>
                <input id="adno" type="text" name="adno" value=" <?php echo $row['adno'] ?>" required />
              </div>
              <div class="item">
              ...
              <div class="item">
                ...
                <input id="bank" type="text" name="bank" value=" <?php echo $row['bank'] ?>" required />
              </div>
              <div class="item">
                <label for="ano">Account Number<span>*</span></label>
                <input id="ano" type="text" name="ano" value=" <?php echo $row['ano'] ?>" required />
              </div>
            </div>
            <div class="item">
