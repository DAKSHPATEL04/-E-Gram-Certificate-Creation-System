...
$sql= "UPDATE death SET name='$name',age='$age', place='$place', religion='$religion', bdate='$bdate', ddate='$ddate' , gender='$gender',Remark='$Remark',Status='$Status' WHERE id='$vid'";
$query=$dbh->prepare($sql);
 ...
 echo "<script>window.location.href ='all-death-application.php'</script>";
}
...
$sql="SELECT * FROM death WHERE id=:vid";
$query = $dbh -> prepare($sql);
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
   ...
   <tr>
    <th>Age:</th>
    <td>
    <input name="age" placeholder="Remark" value="<?php  echo $row->age  ;?>" rows="12" cols="14" class="form-control wd-450" required="true"></td>
  </tr> 
    ...
    <th>Religion :</th>
    <td>
    <input name="religion" placeholder="Remark"  value="<?php  echo $row->religion  ;?>"rows="12" cols="14" class="form-control wd-450" required="true"></td>
  </tr> 
    <tr>
    ...
    <th>Date OF Birth :</th>
    <td>
    <input name="bdate" placeholder="Remark"  value="<?php  echo $row->bdate  ;?>"rows="12" cols="14" class="form-control wd-450" required="true"></td>
  </tr> 
    <tr>
    <th>Date Of Death :</th>
    <td>
    <input name="ddate" placeholder="Remark" rows="12" cols="14" value="<?php  echo $row->ddate  ;?>" class="form-control wd-450" required="true"></td>
  </tr>     
  <tr>
    <th>Gender :</th>
    <td>
