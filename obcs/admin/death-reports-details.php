...
$sql="SELECT * from death where date (created_at) between '$fdate' and '$tdate'";
...
{               ?>
                                                ...
                                                <td><?php  echo htmlentities($row->age);?></td>
                                                 ...
                                                 <td><?php  echo htmlentities($row->ddate);?></td>
...
<?php } ?>
                                                 <td class="datatable-ct"><a href="view-death-detail.php?viewid=<?php echo htmlentities ($row->id);?>"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                                 </td>
                                             </tr>
                                             <?php $cnt=$cnt+1;}} ?>  
