...
$sql= "UPDATE userss SET name='$name',username='$username', password='$password' WHERE id='$vid'";
$query=$dbh->prepare($sql);
 ...
 echo "<script>window.location.href ='all-userss-application.php'</script>";
}
                            ...
                            <div class="sparkline13-list shadow-reset">
                                <div class="sparkline13-hd">
                                    <div class="main-sparkline13-hd">
                                        <h1>View <span class="table-project-n">Detail of</span> Users</h1>
...
$sql="SELECT * FROM userss WHERE id=:vid";
$query = $dbh -> prepare($sql);
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
   ...
   <tr>
    <th>Username:</th>
    <td>
    <input name="username" placeholder="Remark" value="<?php  echo $row->username;?>" rows="12" cols="14" class="form-control wd-450" required="true"></td>
  </tr> 
    ...
    <th>Password:</th>
    <td>
    <input name="password" placeholder="Remark"  value="<?php  echo $row->password;?>"rows="12" cols="14" class="form-control wd-450" required="true"></td>
  </tr> 
