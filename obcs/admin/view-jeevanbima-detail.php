...
$sql= "UPDATE jeevanbima SET name='$name',oop='$oop',email='$email',bdate='$bdate',city='$city',pcode='$pcode',caste='$caste',gender='$gender', pno='$pno', adno='$adno',address='$address', bank='$bank', ano='$ano',Remark='$Remark',Status='$Status'  WHERE id='$vid'";
$query=$dbh->prepare($sql);
 ...
 echo "<script>window.location.href ='all-jeevanbima-application.php'</script>";
}
...
$sql="SELECT * FROM jeevanbima WHERE id=:vid";
$query = $dbh -> prepare($sql);
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
   ...
   <tr>
    ...
    <th>School Name :</th>
    <td>
    <input name="oop" placeholder="Remark"  value="<?php  echo $row->oop;?>"rows="12" cols="14" class="form-control wd-450" required="true"></td>
  </tr> 
    <tr>
    <th>Email ID :</th>
    <td>
    <input name="email"  placeholder="Remark" value="<?php  echo $row->email;?>" rows="12" cols="14" class="form-control wd-450" required="true"></td>
  </tr> 
    <tr>
    <th>Birth Date :</th>
    <td>
  ...
  <tr>
    ...
    <td>
    <input name="adno" placeholder="Remark" rows="12" cols="14" value="<?php  echo $row->adno;?>" class="form-control wd-450" required="true"></td>
  </tr>     
  <tr>
    <th>Address :</th>
    <td>
