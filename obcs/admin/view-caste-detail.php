...
$sql= "UPDATE caste SET name='$name',fname='$fname', mname='$mname', date='$date',place='$place', caste='$caste', gender='$gender',Remark='$Remark',Status='$Status' WHERE id='$vid'";
$query=$dbh->prepare($sql);
 ...
 echo "<script>window.location.href ='all-caste-application.php'</script>";
}
...
$sql="SELECT * FROM caste WHERE id=:vid";
$query = $dbh -> prepare($sql);
