                            ...
                            <div class="sparkline13-list shadow-reset">
                                <div class="sparkline13-hd">
                                    <div class="main-sparkline13-hd">
                                        <h1>View <span class="table-project-n">Detail of</span> Birth </h1>
...
$sql="SELECT * from birth where date(Dateofapply) between '$fdate' and '$tdate'";
                                                ...
                                                <tr>
                                                   ...
                                                   <td><?php echo htmlentities($cnt);?></td>
                                                      ...
                                                      <td><?php  echo htmlentities($row->fname);?></td>
                                                       ...
                                                       <td><?php  echo htmlentities($row->Dateofapply);?></td>
