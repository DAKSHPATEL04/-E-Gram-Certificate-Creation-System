...
<header class="header">
   ...
   <nav class="navbar">
      ...
      <a href="user.php">home</a>
       <a href="Yogna&Events.php">Yojana & Events</a>  
...
<section class="home">
   ...
   <div class="swiper home-slider">
      ...
      <div class="swiper-wrapper">
         ...
         <section class="swiper-slide slide" style="background: url(back2.jpg) no-repeat;">
            <div class="content">
               <h3>Digital India</h3>
               <p>An initiative of Egram society, Under department of panchayat</p>
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <h3>Birth Certificate </h3>
            <form method="post" action="services/birth.php">
       <button type="submit" class="btn btn primary">Apply</button>
        <a href="searchbirth.php" class="btn btn-primary">Show</a>
   </form>
      </div>
      ...
      <div class="box">
         ...
         <form method="post" action="services/cast.php">
       <button type="submit" class="btn btn primary">Apply</button>
        <a href="searchcaste.php" class="btn btn-primary">Show</a>
   </form>
      </div>
      ...
      <div class="box">
        ...
        <form method="post" action="services/marraige.php">
       <button type="submit" class="btn btn primary">Apply</button>
        <a href="searchmarraige.php" class="btn btn-primary">Show</a>
   </form>
      </div>
      ...
      <div class="box">
        ...
        <form method="post" action="services/death.php">
       <button type="submit" class="btn btn primary">Apply</button>
        <a href="searchdeath.php" class="btn btn-primary">Show</a>
   </form>
      </div>
      ...
      <div class="swiper-wrapper">
         ...
         <div class="slide slide">
            ...
            <div class="content">
               ...
               <a href="application.php" class="btn">Apply</a>
            </div>
         </div>
